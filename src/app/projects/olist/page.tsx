...
export default function OlistProject() {
  ...
  return (
    <main className="bg-black text-white min-h-screen px-6 md:px-10 py-10 max-w-6xl mx-auto">
      {/* Header */}
      <section>
        ...
        <p className="mt-6 text-gray-400 text-lg leading-8">
          ...
          Excel, Power BI, DAX, Power Query, GitHub, and modern web technologies
          to analyze e-commerce performance and business operations.
        </p>
      </section>
      {/* Project Overview */}
...
"
          >
            ...
            <p className="mt-2 text-gray-400">Orders Analyzed</p>
          </div>
...
"
          >
            ...
            <p className="mt-2 text-gray-400">Order Items</p>
          </div>
...
"
          >
            ...
            <p className="mt-2 text-gray-400">KPIs Tracked</p>
          </div>
        </div>
      </section>
      {/* Architecture */}
    ...
    "
        ...
        <p className="text-gray-400 mt-4">Click image to enlarge</p>
      </section>
      {/* Tech Stack */}
      <section className="mt-20">
